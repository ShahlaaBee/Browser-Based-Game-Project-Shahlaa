const words = ['APPLE', 'BANANA', 'ORANGE', 'MANGO', 'GRAPES', 'PEAR', 'KIWI', 'POMEGRENATE', 'GUAVA', 'WATERMELON', 'APRICOT'];
const maxAttempts = 6;
let selectedWord = '';
...
function initGame() {
    ...
    correctGuesses[1] = selectedWord[1]; // First letter
    correctGuesses[selectedWord.length - 2] = selectedWord[selectedWord.length - 2]; // Last letter
    wrongGuesses = [];
